...
//                             {test.questionCount} Questions • {test.duration}{" "}
//                             mins
//                           </p>
//                         </div>
...
//                       <div
//                         className="text-center py-8"
//                         data-testid="no-rankings-message"
//                       >
//                         <Users
//                           size={48}
//                           className="mx-auto text-gray-300 mb-3"
...
//                                   (ranking.correctCount +
//                                     ranking.incorrectCount +
//                                     ranking.unattemptedCount)) *
//                                 100
//                               ).toFixed(1);
//                               return (
//                                 <tr
...
//                                     }}
//                                   >
//                                     {Math.floor(ranking.timeTaken / 60)}:
//                                     {(ranking.timeTaken % 60)
//                                       .toString()
//                                       .padStart(2, "0")}
//                                   </td>
...
//                   data-testid="no-test-selected-message"
//                 >
...
//                     Click on a test from the left panel to view analytics
//                   </p>
//                 </div>
//               )}
//             </div>
...
//                 onChange={(e) =>
//                   setFormData({ ...formData, startWindow: e.target.value })
//                 }
//                 className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
//               />
//             </div>
...
//                 onChange={(e) =>
//                   setFormData({ ...formData, endWindow: e.target.value })
//                 }
//                 className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
//               />
//             </div>
...
//                     }
//                     className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent mb-3 whitespace-pre-wrap"
...
//                       )
//                     }
//                     className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent whitespace-pre-wrap"
...
//         ? new Date(data.startWindow).toISOString().slice(0, 16)
//         : "",
//       endWindow: data.endWindow
//         ? new Date(data.endWindow).toISOString().slice(0, 16)
//         : "",
...
const TextFormattingToolbar = ({ onFormat, textareaRef }) => {
  ...
  return (
    <div className="flex gap-2 mb-2 bg-white p-2 rounded-lg border border-gray-200">
      <button
        type="button"
      ...
      <button
        ...
        className="p-2 hover:bg-gray-100 rounded transition-colors"
        title="Italic (*text*) - Select text first"
      >
      ...
      <button
        ...
        className="p-2 hover:bg-gray-100 rounded transition-colors"
        title="Underline (<u>text</u>) - Select text first"
      >
      ...
      <button
        ...
        className="p-2 hover:bg-gray-100 rounded transition-colors"
        title="Bullet List - Select multiple lines"
      >
...
const CreateTestModal = ({ onClose, onSuccess }) => {
  ...
  const handleFormatText = (index, newText) => {
    const newQuestions = [...formData.questions];
          ...
          <div className="border-t border-gray-200 pt-6">
              ...
              {formData.questions.map((question, qIndex) => (
                ...
                >
                  ...
                  <TextFormattingToolbar
                    onFormat={(newText) => handleFormatText(qIndex, newText)}
                    textareaRef={{
                      current: textareaRefs.current[qIndex]
                    }}
                  />

                  <textarea
                    ref={el => textareaRefs.current[qIndex] = el}
                    data-testid={`question-text-input-${qIndex}`}
                    value={question.text}
                    onChange={(e) =>
                      handleQuestionChange(qIndex, "text", e.target.value)
                    }
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent mb-3 whitespace-pre-wrap font-mono"
                    placeholder="Enter question text (use **bold**, *italic*, <u>underline</u>, or • for bullet points)"
                    rows={4}
                  />
            ...
            <div className="mt-6 flex justify-center">
              <button
                ...
                onClick={handleAddQuestion}
                data-testid="add-question-button"
                className="bg-blue-600 text-white px-6 py-3 rounded-lg hover:bg-blue-700 transition-all active:scale-95 flex items-center gap-2 shadow-md"
              >
              ...
              {formData.questions.map((question, qIndex) => (
                ...
                >
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-2 border rounded mb-3 font-mono"
                    rows={4}
                  />
