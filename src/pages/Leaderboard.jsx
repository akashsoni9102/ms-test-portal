...
const Leaderboard = () => {
  ...
  const highestMarks =
    rankings.length > 0
      ? Math.max(...rankings.map((r) => r.marks))
      : 0;
  ...
  const averageMarks =
    rankings.length > 0
      ? (
          rankings.reduce((sum, r) => sum + r.marks, 0) /
          rankings.length
        ).toFixed(2)
      : 0;
                ...
                {currentUserRanking ? (
                  <>
                    ...
                    <p className="text-lg font-semibold text-indigo-600 mt-1">
                      Marks: {currentUserRanking.marks}
                    </p>
                  </>
                ) : (
              ...
              <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                  {topThree.map((ranking, index) => {
                    ...
                    const podiumColors = [
                      { bg: 'bg-gradient-to-br from-yellow-100 to-yellow-200', border: 'border-yellow-400', icon: Trophy },
                      { bg: 'bg-gradient-to-br from-gray-100 to-gray-200', border: 'border-gray-400', icon: Medal },
                      { bg: 'bg-gradient-to-br from-orange-100 to-orange-200', border: 'border-orange-400', icon: Award },
                    ];
                    ...
                    return (
                      <div
                        key={ranking.id}
                        className={`${color.bg} rounded-xl shadow-lg border-2 ${color.border} p-6`}
                      >
                        <div className="text-center">
